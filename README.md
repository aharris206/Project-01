...
### Maddy Gutieruiz
Developed the project proposal documentation, wrote project background, challenges, analysis, and figure descriptions, coordinated project tasks for team members, found data used throughout the project, created figures 3 and 4, compiled figures and developed the presentation, wrote Drought_Monitoring_MG.ipynb, and developed/finalized the README file.
